...
void moon_position( double *in_array, size_t number_of_elements,
                     ...
                     double *out_array2 )
{
    ...
    for (j=0; j<number_of_elements; j++)
    {
        ...
        //Get position of moon in coordinates centered in the center
        //of the Earth
        ae_geocentric_moon_from_orbit(jd_tt, &ae_orb_earth,
