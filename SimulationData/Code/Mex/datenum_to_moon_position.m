function [ altitude,azimuth,distance ] = datenum_to_moon_position( datenum_times )
%Returns three arrays containing (1) altitude, (2) azimuth, and (3)
%distance of the moon at the corresponding times (given in datenum()
%format).
...
%   same size/dimensions as the input.
    ...
    %Use aephem to calculate moon's position
    [altitude,azimuth,distance]=moon_position(unix_times); %gets three components
end
